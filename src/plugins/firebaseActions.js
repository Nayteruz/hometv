...
export const ignore_genre = ['', 'для взрослых', 'мюзикл', 'спорт', 'церемония', 'фильм-нуар', 'биография','вестерн', 'короткометражка', 'документальный', 'документальный', 'реальное ТВ', 'ток-шоу', 'концерт', 'игра', 'новости'];